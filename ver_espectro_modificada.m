function [mfss] = ver_espectro_modificada(senal,ventana,Nfft,fs)
...
%   ventana = tipo de ventana a utilizar (sin solapamiento), posibilidades
...
%   Se dibuja la se�al y su espectro en la ventana de figure activa.
